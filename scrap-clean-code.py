...
url = r'https://libproxy2.usc.edu/login?url=http://www.nexisuni.com'
# url = r'http://libguides.usc.edu/go.php?c=9232127'
username = 'jingyiti'
password = 'Tliutjoy@19930501'
...
def download_file(searchTerms, download_folder, url = url, username = username,                   dead_time = dead_time, path_to_chromedriver=path_to_chromedriver, enddate=__default_enddate):
    while True:
        endmonth,endyear = __default_enddate.split(".")
        ...
        try:
            ...
            # timeline end
            if int(browser.find_element_by_xpath('//*[@id="refine"]/div[2]/div[4]/div[2]/input').get_attribute('value').split('/')[-1]) >= 2014:
